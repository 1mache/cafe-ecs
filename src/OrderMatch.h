...
inline constexpr DrinkGrade reduceGrade(DrinkGrade grade);

constexpr float BASE_GRADE = 1.0f;
 ...
 *
 *  The overview's ratio is compared to the intent's expected ratio;
