...
inline constexpr uint64_t MASK_CLEANUP          = LIQUID | ICE | DRAGGABLE;
inline constexpr uint64_t MASK_DROPSPACE_SENSOR = DRAGGABLE;
inline constexpr uint64_t MASK_DRAGGABLE        = DROPSPACE_SENSOR | BARTOP | MACHINES | DRAGGABLE | CUP_SOLID | CLEANUP;
